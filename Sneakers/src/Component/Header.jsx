...
import cart from "../assets/images/image-product-1.jpg"
const Header = () => {
  return (
    <>
    <div className="w-[100%]">
      <section className="mainContainer flex justify-between py-6  px-4     ">
        <section className="flex space-x-4 ">
          ...
          <div className="logo lg:flex lg:space-x-6">
      ...
      <section className="cartContainer relative flex justify-center  ">
            ...
            <div className="cartItems w-[23rem]  px-8 py-4 h-[20rem]  overflow-scroll rounded-lg top-10 z-50  bg-slate-100 absolute">
          <h1 className="capitalize text-[1.4rem] font-bold border-b-2 border-gray-300 mb-1">cart </h1>
            <section className="flex">
             <div className="carimgContainer w-[50px] h-[50px] my-4">
              <img src={cart} alt="cartimg" className="w-[100%] rounded-lg" />
             </div>
            ...
            <div className="btn flex justify-center">
              <button className=" bg-orange-400 cursor-pointer w-full rounded-md text-slate-100 capitalize py-4">checkout</button>
            </div>
